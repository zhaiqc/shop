...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case CategoryEntity:
			...
			return shopDetailDataManystoretapFromJson(data as ShopDetailDataManystoretap, json) as T;			case BannerEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case CategoryEntity:
			...
			return shopDetailDataManystoretapToJson(data as ShopDetailDataManystoretap);			case BannerEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'CategoryEntity':
			...
			return ShopDetailDataManystoretap().fromJson(json);			case 'BannerEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'CategoryEntity':
			...
			return List<ShopDetailDataManystoretap>();			case 'BannerEntity':
