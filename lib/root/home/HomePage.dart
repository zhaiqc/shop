...
//          );
  ...
  //分类模块
  Widget _selectSortViewCell(int index) {
    return new Container(
      alignment: Alignment.center,
      child: new Material(
              ...
              children: <Widget>[
                ...
                new Container(
                  ...
                  child: new ClipRRect(
                    ...
                    child: SizedBox(
                      child: Image.network("http://static.caibeike.com/i/83f0eeea35ed3d6e9638be0f73c2797b-IzI0dN-bMOMwOOkhp1@!c300",height: AppConfig.logic_width(100),width: AppConfig.logic_width(100),fit: BoxFit.fill,),

//                      child: AppConfig.imageView(new AllModel().homePageModel.classifyList[index].thumbnail,
//                          AppConfig.logic_width(100.0),
//                          AppConfig.logic_width(100.0),
//                          AppConfig.logic_width(40.0),
//                          BoxFit.fill
//                      ),
                    ),
                  ),
